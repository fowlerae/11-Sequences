...
def run_test_count_negatives():
    ...
    # Test 6:
    expected = 2
    actual = count_negatives([-100, 500, 0.10, -0.000300])
    print()
    ...
    # Test 7:
    expected = 3
    actual = count_negatives((-8, -28, 12000, -50))
    print()
...
def run_test_count_short_ones():
    ...
    # Test 8:
    expected = 1
    seq = [[2,5,6,7], [3,3], [6,99,2001,40000], [11,12,19]]
    actual = count_short_ones(seq)
    print()
    ...
    # Test 9:
    expected = 1
    seq = [[101, 101, 22], [99, -189, 1911,2000], [1, 44, -1001], [1]]
    actual = count_short_ones(seq)
    print()
